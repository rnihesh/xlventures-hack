    ...
    return (
      <div className="flex animate-rise justify-end">
        <div className="flex max-w-[85%] items-start gap-3">
          <div className="min-w-0 rounded-2xl rounded-tr-sm bg-secondary px-4 py-2.5 text-sm leading-relaxed text-secondary-foreground">
    ...
    <div className="flex animate-rise justify-start">
      <div className="flex max-w-[85%] items-start gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-2">
          ...
          {content.length > 0 && (
            <div className="min-w-0 overflow-hidden rounded-2xl rounded-tl-sm border border-border bg-card px-4 py-2.5 text-sm leading-relaxed text-card-foreground">
