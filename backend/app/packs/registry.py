...
_COPILOT_TOOLS: List[ToolSpec] = [
    ...
    ToolSpec("create_account", "python", "Create an account in the workspace (notes ingested as evidence).", True, "medium"),
    ToolSpec("list_contacts", "python", "List saved contacts, optionally for one account.", False, "low"),
    ToolSpec("add_contact", "python", "Save a contact (name + email) to the workspace.", True, "low"),
    ToolSpec("list_runs", "python", "List the org's recent NBA runs.", False, "low"),
    ToolSpec("update_account", "python", "Update fields on an existing account.", True, "medium"),
    ToolSpec("get_timeline", "python", "Return an account's audit timeline.", False, "low"),
    ToolSpec("get_integrations", "python", "Return the org's connector status.", False, "low"),
    ToolSpec("record_outcome", "python", "Record a run outcome into the learning loop.", True, "medium"),
